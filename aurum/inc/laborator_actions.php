...
function laborator_init()
{
	...
	# Scripts
	wp_register_script('jquery-ui', THEMEASSETS . 'js/jquery-ui.min.js', null, null, true);
	...
	# Google Maps
	$google_api_key = apply_filters( 'aurum_google_api_key', get_data( 'google_maps_api' ) );
...
function aurum_plugins()
{
	$plugins = array(
		...
		array(
			'name'               => 'Layer Slider',
			'slug'               => 'LayerSlider',
			'source'             => get_template_directory() . '/inc/thirdparty-plugins/layersliderwp-5.6.9.installable.zip',
			'required'           => false,
			'version'            => '5.6.9',
		),
