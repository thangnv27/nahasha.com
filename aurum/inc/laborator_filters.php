...
function shortcode_lab_social_networks($atts = array(), $content = '')
{
	...
	$social_order_list = array(
		"fb"  => array("title" => __("Facebook", 'aurum'), 		"icon" => "entypo-facebook"),
		"tw"  => array("title" => __("Twitter", 'aurum'), 		"icon" => "entypo-twitter"),
		"lin" => array("title" => __("LinkedIn", 'aurum'), 		"icon" => "entypo-linkedin"),
		"yt"  => array("title" => __("YouTube", 'aurum'), 		"icon" => "entypo-play"),
		"vm"  => array("title" => __("Vimeo", 'aurum'), 		"icon" => "entypo-vimeo"),
		"drb" => array("title" => __("Dribbble", 'aurum'), 		"icon" => "entypo-dribbble"),
		"ig"  => array("title" => __("Instagram", 'aurum'), 	"icon" => "entypo-instagram"),
		"pi"  => array("title" => __("Pinterest", 'aurum'), 	"icon" => "entypo-pinterest"),
		"gp"  => array("title" => __("Google+", 'aurum'), 		"icon" => "entypo-gplus"),
		"vk"  => array("title" => __("VKontakte", 'aurum'), 	"icon" => "entypo-vkontakte"),
		"sc"  => array("title" => __("SoundCloud", 'aurum'), 	"icon" => "entypo-soundcloud"),
		"tb"  => array("title" => __("Tumblr", 'aurum'), 		"icon" => "entypo-tumblr"),
		"rs"  => array("title" => __("RSS", 'aurum'), 			"icon" => "entypo-rss"),
	);
